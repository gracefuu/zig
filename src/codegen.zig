...
fn Function(comptime arch: std.Target.Cpu.Arch) type {
    ...
    return struct {
        ...
        fn genNot(self: *Self, inst: *ir.Inst.UnOp) !MCValue {
            ...
            switch (arch) {
                .x86_64 => {
                    ...
                    return try x86_64.genX8664BinMath(Self, self, &inst.base, inst.operand, &imm.base);
                },
                .arm, .armeb => {
                    var imm = ir.Inst.Constant{
                        .base = .{
        ...
        fn genAdd(self: *Self, inst: *ir.Inst.BinOp) !MCValue {
            ...
            switch (arch) {
                .x86_64 => {
                    return try x86_64.genX8664BinMath(Self, self, &inst.base, inst.lhs, inst.rhs);
                },
        ...
        fn genMul(self: *Self, inst: *ir.Inst.BinOp) !MCValue {
            ...
            if (inst.base.isUnused())
                return MCValue.dead;
            switch (arch) {
                .x86_64 => return try x86_64.genX8664BinMath(Self, self, &inst.base, inst.lhs, inst.rhs),
        ...
        fn genCmp(self: *Self, inst: *ir.Inst.BinOp, op: math.CompareOperator) !MCValue {
            ...
            switch (arch) {
                .x86_64 => {
                    ...
                    try x86_64.genX8664BinMathCode(Self, self, inst.base.src, inst.base.ty, dst_mcv, src_mcv, 7, 0x38);
        ...
        fn genBoolOp(self: *Self, inst: *ir.Inst.BinOp) !MCValue {
            ...
            switch (arch) {
                .x86_64 => switch (inst.base.tag) {
                    // lhs AND rhs
                    .bool_and => return try x86_64.genX8664BinMath(Self, self, &inst.base, inst.lhs, inst.rhs),
                    // lhs OR rhs
                    .bool_or => return try x86_64.genX8664BinMath(Self, self, &inst.base, inst.lhs, inst.rhs),
        ...
        pub fn genSetStack(self: *Self, src: LazySrcLoc, ty: Type, stack_offset: u32, mcv: MCValue) InnerError!void {
            switch (arch) {
                ...
                .x86_64 => switch (mcv) {
                    ...
                    .register => |reg| {
                        try x86_64.genX8664ModRMRegToStack(Self, self, src, ty, stack_offset, reg, 0x89);
                    },
                    .memory => |vaddr| {
                        return self.fail(src, "TODO implement set stack variable from memory vaddr", .{});
                    },
