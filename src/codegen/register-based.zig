...
const X8664Encoder = @import("x86_64.zig").Encoder;
...
pub fn Function(comptime arch: std.Target.Cpu.Arch) type {
    ...
    return struct {
        ...
        /// Alias of the architecture specific definition of RegisterManager
        ///
        /// Code duplication is to make ZLS happier
        const RegisterManager = switch (arch) {
            .x86_64 => @import("x86_64.zig").RegisterManager,
            .arm, .armeb => @import("arm.zig").RegisterManager,
            .aarch64, .aarch64_be, .aarch64_32 => @import("aarch64.zig").RegisterManager,
            .riscv64 => @import("riscv64.zig").RegisterManager,
            .spu_2 => @import("spu-mk2.zig").RegisterManager,
            else => @panic("Unsupported register based machine"),
        };

        /// Alias of the architecture specific definition of MCValue
        ///
        /// Code duplication is to make ZLS happier
        const MCValue = switch (arch) {
            .x86_64 => @import("x86_64.zig").MCValue,
            .arm, .armeb => @import("arm.zig").MCValue,
            .aarch64, .aarch64_be, .aarch64_32 => @import("aarch64.zig").MCValue,
            .riscv64 => @import("riscv64.zig").MCValue,
            .spu_2 => @import("spu-mk2.zig").MCValue,
            else => @panic("Unsupported register based machine"),
        };

        /// Alias of the architecture specific definition of Branch
        ///
        /// Code duplication is to make ZLS happier
        const Branch = switch (arch) {
            .x86_64 => @import("x86_64.zig").Branch,
            .arm, .armeb => @import("arm.zig").Branch,
            .aarch64, .aarch64_be, .aarch64_32 => @import("aarch64.zig").Branch,
            .riscv64 => @import("riscv64.zig").Branch,
            .spu_2 => @import("spu-mk2.zig").Branch,
            else => @panic("Unsupported register based machine"),
        };
